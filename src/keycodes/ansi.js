export default [
  ...
  { name: '~\n`', code: 'KC_GRV', keys: '`', hiragana: 'ろ', cyrillics: 'Ё' },
  { name: '!\n1', code: 'KC_1', keys: '1', hiragana: 'ぬ' },
  { name: '@\n2', code: 'KC_2', keys: '2', hiragana: 'ふ', cyrillics: '"\n2' },
  { name: '#\n3', code: 'KC_3', keys: '3', hiragana: 'あ', cyrillics: '№\n3' },
  { name: '$\n4', code: 'KC_4', keys: '4', hiragana: 'う', cyrillics: ';\n4' },
  { name: '%\n5', code: 'KC_5', keys: '5', hiragana: 'え', cyrillics: '%\n5' },
  { name: '^\n6', code: 'KC_6', keys: '6', hiragana: 'お', cyrillics: ':\n6' },
  ...
  { name: 'Q', code: 'KC_Q', keys: 'q', hiragana: 'た', hangul: 'ㅂ', cyrillics: 'Й' },
  { name: 'W', code: 'KC_W', keys: 'w', hiragana: 'て', hangul: 'ㅈ', cyrillics: 'Ц' },
  { name: 'E', code: 'KC_E', keys: 'e', hiragana: 'い', hangul: 'ㄷ', cyrillics: 'У' },
  { name: 'R', code: 'KC_R', keys: 'r', hiragana: 'す', hangul: 'ㄱ', cyrillics: 'К' },
  { name: 'T', code: 'KC_T', keys: 't', hiragana: 'か', hangul: 'ㅅ', cyrillics: 'Е' },
  { name: 'Y', code: 'KC_Y', keys: 'y', hiragana: 'ん', hangul: 'ㅛ', cyrillics: 'H' },
  { name: 'U', code: 'KC_U', keys: 'u', hiragana: 'な', hangul: 'ㅕ', cyrillics: 'Г' },
  { name: 'I', code: 'KC_I', keys: 'i', hiragana: 'に', hangul: 'ㅑ', cyrillics: 'Ш' },
  { name: 'O', code: 'KC_O', keys: 'o', hiragana: 'ら', hangul: 'ㅐ', cyrillics: 'Щ' },
  { name: 'P', code: 'KC_P', keys: 'p', hiragana: 'せ', hangul: 'ㅔ', cyrillics: 'З' },
  { name: '{\n[', code: 'KC_LBRC', keys: '[', hiragana: '゛', cyrillics: 'X' },
  { name: '}\n]', code: 'KC_RBRC', keys: ']', hiragana: '゜', cyrillics: 'Ъ' },
  { name: '|\n\\', code: 'KC_BSLS', keys: '\\', hiragana: 'む', width: 1500, cyrillics: '/\n\\' },
  { width: 250 },
  ...
  { name: 'A', code: 'KC_A', keys: 'a', hiragana: 'ち', hangul: 'ㅁ', cyrillics: 'Ф' },
  { name: 'S', code: 'KC_S', keys: 's', hiragana: 'と', hangul: 'ㄴ', cyrillics: 'Ы' },
  { name: 'D', code: 'KC_D', keys: 'd', hiragana: 'し', hangul: 'ㅇ', cyrillics: 'B' },
  { name: 'F', code: 'KC_F', keys: 'f', hiragana: 'は', hangul: 'ㄹ', cyrillics: 'A' },
  { name: 'G', code: 'KC_G', keys: 'g', hiragana: 'き', hangul: 'ㅎ', cyrillics: 'П' },
  { name: 'H', code: 'KC_H', keys: 'h', hiragana: 'く', hangul: 'ㅗ', cyrillics: 'P' },
  { name: 'J', code: 'KC_J', keys: 'j', hiragana: 'ま', hangul: 'ㅓ', cyrillics: 'O' },
  { name: 'K', code: 'KC_K', keys: 'k', hiragana: 'の', hangul: 'ㅏ', cyrillics: 'Л' },
  { name: 'L', code: 'KC_L', keys: 'l', hiragana: 'り', hangul: 'ㅣ', cyrillics: 'Д' },
  { name: ':\n;', code: 'KC_SCLN', keys: ';', hiragana: 'れ', cyrillics: 'Ж' },
  { name: '"\n\'', code: 'KC_QUOT', keys: "'", hiragana: 'け', cyrillics: 'Э' },
  ...
  { name: 'Z', code: 'KC_Z', keys: 'z', hiragana: 'つ', hangul: 'ㅋ', cyrillics: 'Я' },
  { name: 'X', code: 'KC_X', keys: 'x', hiragana: 'さ', hangul: 'ㅌ', cyrillics: 'Ч' },
  { name: 'C', code: 'KC_C', keys: 'c', hiragana: 'そ', hangul: 'ㅊ', cyrillics: 'C' },
  { name: 'V', code: 'KC_V', keys: 'v', hiragana: 'ひ', hangul: 'ㅍ', cyrillics: 'M' },
  { name: 'B', code: 'KC_B', keys: 'b', hiragana: 'こ', hangul: 'ㅠ', cyrillics: 'И' },
  { name: 'N', code: 'KC_N', keys: 'n', hiragana: 'み', hangul: 'ㅜ', cyrillics: 'T' },
  { name: 'M', code: 'KC_M', keys: 'm', hiragana: 'も', hangul: 'ㅡ', cyrillics: 'Ь' },
  { name: '<\n,', code: 'KC_COMM', keys: ',', hiragana: 'ね', cyrillics: 'Б' },
  { name: '>\n.', code: 'KC_DOT', keys: '.', hiragana: 'る', cyrillics: 'Ю' },
  { name: '?\n/', code: 'KC_SLSH', keys: '/', hiragana: 'め', cyrillics: ',\n.' },
