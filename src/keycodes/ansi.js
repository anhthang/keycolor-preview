export default [
  ...
  { name: '~\n`', code: 'KC_GRV', keys: '`', japanese: 'ろ' },
  { name: '!\n1', code: 'KC_1', keys: '1', japanese: 'ぬ' },
  { name: '@\n2', code: 'KC_2', keys: '2', japanese: 'ふ' },
  { name: '#\n3', code: 'KC_3', keys: '3', japanese: 'あ' },
  { name: '$\n4', code: 'KC_4', keys: '4', japanese: 'う' },
  { name: '%\n5', code: 'KC_5', keys: '5', japanese: 'え' },
  { name: '^\n6', code: 'KC_6', keys: '6', japanese: 'お' },
  { name: '&\n7', code: 'KC_7', keys: '7', japanese: 'や' },
  { name: '*\n8', code: 'KC_8', keys: '8', japanese: 'ゆ' },
  { name: '(\n9', code: 'KC_9', keys: '9', japanese: 'よ' },
  { name: ')\n0', code: 'KC_0', keys: '0', japanese: 'わ' },
  { name: '_\n-', code: 'KC_MINS', keys: '-', japanese: 'ほ' },
  { name: '+\n=', code: 'KC_EQL', keys: '=', japanese: 'へ' },
  ...
  { name: 'Q', code: 'KC_Q', keys: 'q', japanese: 'た' },
  { name: 'W', code: 'KC_W', keys: 'w', japanese: 'て' },
  { name: 'E', code: 'KC_E', keys: 'e', japanese: 'い' },
  { name: 'R', code: 'KC_R', keys: 'r', japanese: 'す' },
  { name: 'T', code: 'KC_T', keys: 't', japanese: 'か' },
  { name: 'Y', code: 'KC_Y', keys: 'y', japanese: 'ん' },
  { name: 'U', code: 'KC_U', keys: 'u', japanese: 'な' },
  { name: 'I', code: 'KC_I', keys: 'i', japanese: 'に' },
  { name: 'O', code: 'KC_O', keys: 'o', japanese: 'ら' },
  { name: 'P', code: 'KC_P', keys: 'p', japanese: 'せ' },
  { name: '{\n[', code: 'KC_LBRC', keys: '[', japanese: '゛' },
  { name: '}\n]', code: 'KC_RBRC', keys: ']', japanese: '゜' },
  { name: '|\n\\', code: 'KC_BSLS', keys: '\\', japanese: 'む', width: 1500 },
  { width: 250 },
  ...
  { name: 'A', code: 'KC_A', keys: 'a', japanese: 'ち' },
  { name: 'S', code: 'KC_S', keys: 's', japanese: 'と' },
  { name: 'D', code: 'KC_D', keys: 'd', japanese: 'し' },
  { name: 'F', code: 'KC_F', keys: 'f', japanese: 'は' },
  { name: 'G', code: 'KC_G', keys: 'g', japanese: 'き' },
  { name: 'H', code: 'KC_H', keys: 'h', japanese: 'く' },
  { name: 'J', code: 'KC_J', keys: 'j', japanese: 'ま' },
  { name: 'K', code: 'KC_K', keys: 'k', japanese: 'の' },
  { name: 'L', code: 'KC_L', keys: 'l', japanese: 'り' },
  { name: ':\n;', code: 'KC_SCLN', keys: ';', japanese: 'れ' },
  { name: '"\n\'', code: 'KC_QUOT', keys: "'", japanese: 'け' },
  ...
  { name: 'Z', code: 'KC_Z', keys: 'z', japanese: 'つ' },
  { name: 'X', code: 'KC_X', keys: 'x', japanese: 'さ' },
  { name: 'C', code: 'KC_C', keys: 'c', japanese: 'そ' },
  { name: 'V', code: 'KC_V', keys: 'v', japanese: 'ひ' },
  { name: 'B', code: 'KC_B', keys: 'b', japanese: 'こ' },
  { name: 'N', code: 'KC_N', keys: 'n', japanese: 'み' },
  { name: 'M', code: 'KC_M', keys: 'm', japanese: 'も' },
  { name: '<\n,', code: 'KC_COMM', keys: ',', japanese: 'ね' },
  { name: '>\n.', code: 'KC_DOT', keys: '.', japanese: 'る' },
  { name: '?\n/', code: 'KC_SLSH', keys: '/', japanese: 'め' },
